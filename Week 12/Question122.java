 ...
 * Question 12.2 :
 * 
 * A partial code fragment is given. The URL class object is created in try
 * block.You should write appropriate method( ) to print the protocol name and
 * host name from the given URL string.
 * 
 * For example:
 * 
