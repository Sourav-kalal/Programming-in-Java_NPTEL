...
import java.util.Scanner;
 ...
 public class Question32 extends Point{
	 ...
	 p.x=sc.nextDouble();
	 p.y=sc.nextDouble(); 
	 Question32 c1=new Question32(); //Create an object of class Question32
	 c1.distance(c,p);  //Calcualte radius of the Question32
