...
/**
 * 
 * Complete the code to perform a 45 degree anti clock wise rotation with
 * respect to the center of a 5 × 5 2D Array as shown below:
 * 
 * INPUT: 
 *  00100 
 *  00100 
 ...
 *  10001
 * 
 * Note the following points carefully: 1. Here, instead of 0 and 1 any
 * character may be given. 2. The input and output array size must be of
 * dimension 5 × 5 and nothing else.
 */
...
public class Question93 {
    public static void main(String args[]) {
        ...
        String outer[] = { "00", "10", "20", "30", "40", "41", "42", "43", "44", "34", "24", "14", "04", "03", "02",
                "01" };
