 ...
 * which replaces all input elements with values 0 by 1 and 1 by 0. An example
 * is shown below:
 * 
 * INPUT: 
 * 00001 
 ...
 * 11110
 * 
 * Note the following points carefully: 1. Here, the input must contain only 0
 * and 1. 2. The input and output array size must be of dimension 5 × 5. 3.
